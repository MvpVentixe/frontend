        ...
        <div className='navbar-flex'>
          ...
          { isAuthenticated && (
            <>
              ...
              <Link className='text-decoration' to="/addeventform">
                <button className='navbar-btn' > <img className='navbar-icon' src="/Icons/System/Plus.svg" alt="booking icon" /> <span id='icon-names'> Bookings </span> </button>
              </Link>
              <button onClick={handleSignOut} disabled={loading} className='navbar-btn' > <img className='navbar-icon' src="/Icons/Nav/Vector-1.svg" alt="sign out icon" /> <span id='icon-names'> Sign Out </span> </button>
            </>
